...
# SIEMPRE TENER EN CUENTA QUE LA INDENTACION ES CLAVE YA QUE EN PHYTON NO EXISTEN LLAVES.
...
# Ya que las funciones estan devolviendo algo, al llamar la funciones se deben asignar a una variable.
...
# En caso de que no se asignen las variables, no podra ver lo que las funciones retorna.
...
# Llamar a una funcion dentro de la misma funcion.
