...
###### Son como un array de caracteres.
caracter = texto[4] # Podemos seleccionar un caracter por índice.
print(caracter)

# Len (Length) (Te da el largo del texto).
amplitud = len(texto)
print(amplitud)

# In: para saber si está incluído algo en el texto. Es case sensitive.
print("Python" in texto) # devuelve un booleano según corresponda.

# Not in : con la palabra reservada not podemos negar y pedir un resultado negativo. Es case sensitive.
print("JavaScript" not in texto) # devuelve un booleano según corresponda.

# Slice (cortar) una parte del texto.
# Los stands si son incluídos pero los stops no.
...
texto_con_espacios = "          hola Tierra       "
texto_con_comas = "I/ a'm/ an/ otaku/ bestie"
...
reemplazo = texto_con_espacios.replace("Tierra", "Saturno") # Reeamplazará mundo por universo.
...
estaComenzando = texto_a_modificar.startswith("este") # Comienza con esto? (Case sensitive).
estaFinalizando = texto_a_modificar.endswith("MODIFICAR")# Termina con esto? (Case sensitive).
...
b = "Mundo"
c = a + " " + b
print(c) # Imprimirá concatenadas a y b.
...
# Backslash puede escapar a backslash.
